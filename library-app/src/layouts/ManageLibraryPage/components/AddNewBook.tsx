...
export const AddNewBook = () => {
    ...
    function categoryField(category: string) {
    ...
    function submitNewBook() {
        if (authState?.isAuthenticated && title !== '' && author !== '' && category !== 'Category' 
            ...
            const AddBookRequestModel = new AddBookRequest(title, author, description, copies, category, selectedImage);

            api.addNewBook({data: AddBookRequestModel, headers: requestOptions.headers})
            .then((res) => {
                setTitle('');
                setAuthor('');
                setDescription('');
