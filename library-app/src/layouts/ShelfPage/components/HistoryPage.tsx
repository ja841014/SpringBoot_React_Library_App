...
export const HistoryPage = () => {
    ...
    const historiesPerPage: number = 5;
    ...
    useEffect(() => {
        ...
        if(authState && authState.isAuthenticated) {
            ...
            const params = {page: currentPage - 1, size: historiesPerPage};

            api.getHistory({headers: requestOptions, params: params})
            .then((res) => {
                ...
                const histories = Object.keys(responseData).map((key: any) => (
                    {
