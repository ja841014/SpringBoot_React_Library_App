...
export const Loans = () => {
    ...
    useEffect(() => {
        if(authState && authState.isAuthenticated) {
            ...
            api.getLoansDetail({headers: requestOptions})
            .then((res) => {
                const responseData = res.data;

                const shelfAllLoans = Object.keys(responseData).map((key: any) => (
                {
    ...
    function returnBook(bookId: number) {
        ...
        api.returnBook({params: bookId, headers: requestOptions})
        .then((res) => {
    ...
    function renewLoan(bookId: number) {
        const requestOptions = oktaHeaderSetup();
        api.renewLoan({params: bookId, headers: requestOptions})
        .then((res) => {
            setCheckout(!checkout);
        })
        .catch((error) => {
