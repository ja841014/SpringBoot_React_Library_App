...
export const LeaveAReview = (props: any) => {
    ...
    return (
        <div className='dropdown' style={{ cursor: 'pointer' }}>
            ...
            <StarsReview rating={star} size={32}/>
            ...
            {displayInput && 
                <form method='POST' action='#'>
                    ...
                    <div>
                        <button type='button' onClick={() => props.submitReview(star, reviewDescription)} className='btn btn-primary mt-3'>Submit Review</button>
                    </div>
                </form>
            }
